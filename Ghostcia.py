...
@is_option
def IP_Track():
    ip = input(f"{Wh}\n Enter Target Ip : {Gr}")  # INPUT IP ADDRESS
    print()
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter Nomor Telephone target {Gr}Ex [+6281xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
...
options = [
    ...
    {
        'num': 3,
        'text': 'Lacak nomer telephone',
        'func': phoneGW
    },
    {
        'num': 4,
        'text': 'Lacak Username Orang',
        'func': TrackLu
    },
    {
        'num': 0,
...
/_/ |_/_____/  |___/\____/___/_/  |_/_/  |_|
...
def run_banner():
 ...
 / /_/ / _` | '_ \| __| | | |//_\\ | |/ _` | | '_ \ 
/ __  / (_| | | | | |_| |_| /  _  \| | (_| | | |_) |
\/ /_/ \__,_|_| |_|\__|\__,_\_/ \_// |\__,_|_|_.__/ 
                                 |__/               
